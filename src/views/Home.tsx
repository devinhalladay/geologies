    ...
    <div className="sm:px-12">
      ...
      <p className="indent-8 mb-4">
        <span>
          <a
            ...
            className="inline underline decoration-dotted hover:bg-moss/5 transition-all rounded-md"
          >
      ...
      <p>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="underline decoration-dotted hover:bg-moss/5 transition-all rounded-md"
        >
          @theflowingsky
        </a>
      </p>
